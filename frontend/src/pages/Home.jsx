      ...
      {homeSections.map((section, index) => {
        ...
        return (
          <div key={section._id} className="w-full border-b border-neutral-200/60 shadow-[0_4px_16px_rgba(0,0,0,0.02)] relative z-10">
            <section className={`pt-6 pb-2 md:pt-10 md:pb-4 px-4 max-w-7xl mx-auto w-full ${section.type === 'sale' ? 'bg-gradient-to-b from-red-50/40 to-transparent' : ''}`}>
            <SectionHeader 
              emoji={section.emoji} 
              title={section.title}
      ...
      {!loading && homeSections.length === 0 && (
        <div className="w-full">
          <div className="w-full border-b border-neutral-200/60 shadow-[0_4px_16px_rgba(0,0,0,0.02)] relative z-10">
            <section id="newest" className="pt-6 pb-2 md:pt-10 md:pb-4 px-4 max-w-7xl mx-auto w-full">
          ...
          <div className="w-full border-b border-neutral-200/60 shadow-[0_4px_16px_rgba(0,0,0,0.02)] relative z-10">
            <section id="featured" className="pt-6 pb-2 md:pt-10 md:pb-4 px-4 max-w-7xl mx-auto w-full">
          ...
          {onSale.length > 0 && (
            <div className="w-full border-b border-neutral-200/60 shadow-[0_4px_16px_rgba(0,0,0,0.02)] relative z-10">
              <section className="pt-6 pb-2 md:pt-10 md:pb-4 px-4 max-w-7xl mx-auto w-full bg-gradient-to-b from-red-50/40 to-transparent">
