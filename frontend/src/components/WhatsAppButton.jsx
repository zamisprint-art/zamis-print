...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      {/* Tooltip contextual */}
      <span
        className="hidden sm:block bg-white text-neutral-800 text-sm font-semibold px-4 py-2 rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.1)] border border-neutral-100 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 whitespace-nowrap"
      >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-[#25D366] rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex items-center justify-center hover:shadow-[0_8px_30px_rgba(37,211,102,0.3)] transition-shadow pointer-events-auto"
      >
